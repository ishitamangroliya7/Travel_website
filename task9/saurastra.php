    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                <div class="saurastra-banner banner-box">
                    <div class="mask"></div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 col-lg-8 banner-content">
                            <h1 data-aos="zoom-in" data-aos-delay="150"
                            data-aos-duration="1000">SAURASTRA</h1>
                        </div>
                    </div>
                </div>
            </section>

            <section class="saurastra-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Saurastra</h1>
                                <div>
                                    <h4 class="pb-2">₹5,500 / <small>person</small></h4>
                                    <h6>Duration: 6 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>Saurashtra, located in the western part of Gujarat, India, is a vibrant and culturally
                                rich region offering a blend of historical, spiritual, and natural attractions. Here's a
                                detailed tour description of Saurashtra, covering its key highlights:
