    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                <div class="haridwar-banner banner-box">
                    <div class="mask"></div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 col-lg-8 banner-content">
                            <h1 data-aos="zoom-in" data-aos-delay="150" data-aos-duration="1000">HARIDWAR</h1>
                        </div>
                    </div>
                </div>
            </section>

            <section class="haridwar-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Haridwar</h1>
                                <div>
                                    <h4 class="pb-2">19,500 / <small>person</small></h4>
                                    <h6>Duration: 10 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>
                                Rajasthan, known as the "Land of Kings," offers a vibrant mix of history, culture, and
                                natural beauty. This tour through Rajasthan will take you on a journey through opulent
                                palaces, formidable forts, lively bazaars, and picturesque landscapes.
                                ...
                                <div class="col-lg-9 pt-5">
                                    ...
                                    <div id="accordionExample" class="accordion pt-3">
                                        ...
                                        <div class="accordion-item">
                                            <h5 class="accordion-header p-0" id="headingsix">
                                                <button class="accordion-button collapsed" aria-expanded="false"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapsesix" aria-controls="collapsesix">Day6:
                                                </button>
                                            </h5>
                                        ...
                                        <div class="accordion-item">
                                            <h5 class="accordion-header p-0" id="headingseven">
                                                <button class="accordion-button collapsed" aria-expanded="false"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseseven" aria-controls="collapseseven">Day7:
                                                </button>
                                            </h5>
                                        ...
                                        <div class="accordion-item">
                                            <h5 class="accordion-header p-0" id="headingeight">
                                                <button class="accordion-button collapsed" aria-expanded="false"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseeight" aria-controls="collapseeight">Day8:
                                                </button>
                                            </h5>
                                        ...
                                        <div class="accordion-item">
                                            <h5 class="accordion-header p-0" id="headingnine">
                                                <button class="accordion-button collapsed" aria-expanded="false"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapsenine" aria-controls="collapsenine">Day9:
                                                </button>
                                            </h5>
                                        ...
                                        <div class="accordion-item">
                                            <h5 class="accordion-header p-0" id="headingten">
                                                <button class="accordion-button collapsed" aria-expanded="false"
                                                    type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseten" aria-controls="collapseten">Day10:
                                                </button>
                                            </h5>
                        ...
                        <div class="row ">
                            ...
                            <div class="col text-end pt-5">
                                <button type="button" class="btn theme-btn" data-bs-toggle="modal"
                                    data-bs-target="#bookTourModal">Book Now</button>
                            </div>
                        </div>
                    </div>
                </div>
