    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                    <div class="banner-box manali-banner">
                        <div class="mask"></div>
                        <div class="row justify-content-center">
                            <div class="col-sm-7 col-lg-8 banner-content">
                                <h1 data-aos="zoom-in" data-aos-delay="150"
                                data-aos-duration="1000">MANALI</h1>
                            </div>
                        </div>
                    </div>
            </section>

            <section class="manali-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Manali</h1>
                                <div>
                                    <h4 class="pb-2">₹8,200 / <small>person</small></h4>
                                    <h6>Duration: 8 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>Manali is a picturesque hill station nestled in the Kullu Valley of Himachal Pradesh, India. Renowned for its breathtaking landscapes, lush greenery, and snow-capped mountains, Manali is a popular destination for nature lovers, adventure enthusiasts, and honeymooners alike</div>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header p-0" id="headingsix">
                                        <button class="accordion-button collapsed" aria-expanded="false" type="button"
                                            ...
                                            aria-controls="collapsesix">Day6: </button>
                                    </h5>
                                ...
                                <div class="accordion-item">
                                    <h5 class="accordion-header p-0" id="headingseven">
                                        <button class="accordion-button collapsed" aria-expanded="false" type="button"
                                            ...
                                            aria-controls="collapseseven">Day7: </button>
                                    </h5>
