    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                <div class="goa-banner banner-box">
                    <div class="mask"></div>
                    <div class="row justify-content-center">
                        <div class="col-sm-7 col-lg-8 banner-content" >
                            <h1 data-aos="zoom-in" data-aos-delay="150"
                            data-aos-duration="1000">GOA</h1>
                        </div>
                    </div>
                </div>
            </section>

            <section class="goa-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Goa</h1>
                                <div>
                                    <h4 class="pb-2">₹12,200 / <small>person</small></h4>
                                    <h6>Duration: 6 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>Embark on an unforgettable journey to Goa, the pearl of the Indian Ocean, where
                                sun-kissed beaches, lush landscapes, and a vibrant blend of Indian and Portuguese
                                cultures await you. This 7-day tour offers the perfect mix of relaxation, adventure, and
                                cultural exploration, ensuring a memorable vacation experience.</h6>
                        </div>
