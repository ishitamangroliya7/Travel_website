    ...
    <?php include("inc/header3.php"); ?>
        ...
        <main>
            ...
            <section id="home" class="banner">
                    <div class="rajasthan-banner banner-box">
                        <div class="mask"></div>
                        <div class="row justify-content-center">
                            <div class="col-sm-7 col-lg-8 banner-content">
                                <h1 data-aos="zoom-in" data-aos-delay="150"
                                data-aos-duration="1000">RAJASTHAN</h1>
                            </div>
                        </div>
                    </div>
            </section>

            <section class="rajasthan-packages p-0">
                <div class="container">
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <h1 class="secondary">Rajasthan</h1>
                                <div>
                                    <h4 class="pb-2">6,500 / <small>person</small></h4>
                                    <h6>Duration: 5 Days</h6>
                                </div>
                            </div>
                            <h4 class="pt-3 secondary">About:</h4>
                            <h6>
                                Rajasthan, known as the "Land of Kings," offers a vibrant mix of history, culture, and natural beauty. This tour through Rajasthan will take you on a journey through opulent palaces, formidable forts, lively bazaars, and picturesque landscapes.
